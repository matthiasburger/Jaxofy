...
namespace DasTeamRevolution.Migrations
{
    ...
    [Migration("20210621080446_AddedGenderAndIsActiveToPoolEmployee")]
    partial class AddedGenderAndIsActiveToPoolEmployee
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DasTeamRevolution.Data.Models.EmployeeDocument", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("DasTeamRevolution.Data.Models.TimeRecord", b =>
                {
                    ...
                    b.Property<decimal?>("AmountClient")
                        .HasColumnType("decimal(5,2)")
                        .HasColumnName("AmountClient");

                    b.Property<decimal?>("AmountTariffFixed")
                        .HasColumnType("decimal(5,2)")
                        .HasColumnName("AmountTariffFixed");

                    b.Property<decimal?>("AmountWageFixed")
                        .HasColumnType("decimal(5,2)")
                        .HasColumnName("AmountWageFixed");
                    ...
                    b.Property<long?>("ExportedBy")
                        .HasColumnType("bigint")
                        .HasColumnName("ExportedBy");

                    b.Property<DateTime?>("ExportedOn")
                        .HasColumnType("datetime2")
                        .HasColumnName("ExportedOn");

                    b.Property<long?>("LastModificationId")
                        .HasColumnType("bigint");

                    b.Property<bool>("MaxHourEntry")
                        .HasColumnType("bit")
                        .HasColumnName("MaxHourEntry");

                    b.Property<DateTime?>("RemovedOn")
                        .HasColumnType("datetime2")
                        .HasColumnName("RemovedOn");

                    b.Property<long?>("ReportDocumentId")
                        .HasColumnType("bigint")
                        .HasColumnName("ReportDocumentId");
            ...
            modelBuilder.Entity("DasTeamRevolution.Data.Models.Proposal", b =>
                {
                    b.HasOne("DasTeamRevolution.Data.Models.Assignment", "Assignment")
                        .WithOne("Proposal")
                        .HasForeignKey("DasTeamRevolution.Data.Models.Proposal", "AssignmentId");
